...
def main():
    ...
    p.add_argument('--subtree-directories', type=positive, default=1000)
    p.add_argument('--subtree-stats', type=positive, default=10000)
    p.add_argument('--subtree-entries', type=positive, default=250000)
    p.add_argument('--subtree-seconds', type=positive, default=30)
